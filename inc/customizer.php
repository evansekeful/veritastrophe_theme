<?php
/**
 * veritastrophe Theme Customizer
 *
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'veritastrophe_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'veritastrophe_customize_partial_blogdescription',
			)
		);
	}
}
add_action( 'customize_register', 'veritastrophe_customize_register' );
 ...
 * @return void
 */
function veritastrophe_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function veritastrophe_customize_partial_blogdescription() {
